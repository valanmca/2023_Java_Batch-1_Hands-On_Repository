...
<head>
<br><br>
<h1><b>Insert Student Details</b></h1>
...
<table width="60%" align="center" class="table table-striped w-50" border="5" >
	...
	<tr><td><b>Student Department</b></td><td><input type="text" placeholder="Student Department" name="StuDepart" required /></td></tr>
	<tr><td colspan="2" align="center">
<input type="submit" name="sms_button" class="btn btn-outline-success" value="Insert Student" /></td></tr>
