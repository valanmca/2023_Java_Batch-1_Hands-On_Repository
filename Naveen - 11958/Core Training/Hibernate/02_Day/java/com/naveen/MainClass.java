...
//		System.out.println("Object Saved");
		...
		//Native query - delete
//		NativeQuery<Employee> query =  session.createSQLQuery("delete from tbl_employee where emp_id=106");
//		query.addEntity(Employee.class);
//		int n = query.executeUpdate();
//		if (n == 1)
//			System.out.println("Record Deleted!");
...
//		System.out.println("Object Saved");
		...
		//Native query - update
//		NativeQuery<Employee> query =  session.createSQLQuery("update tbl_employee set salary = 1000 where emp_id=101");
//		query.addEntity(Employee.class);
//		int n = query.executeUpdate();
//		if (n == 1)
//			System.out.println("Record Updated!");
