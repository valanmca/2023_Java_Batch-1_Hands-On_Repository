  ...
  <div class="card class" style="width: 35rem;">
   <div class="card-body">
    ...
    <div class="form-group row">
      <label for="studentRollNo" class="col-sm-4 col-form-label text-light">Student Id </label>
      <div class="col-sm-8">
     ...
     <div class=" form-group row">
      <label for="studentEmail" class="col-sm-4 col-form-label  text-light">Student Department</label>
      <div class="col-sm-8">
     ...
     <input type="submit" class="btn" value="Insert Student" onclick="validate()" name="sms"/>
    </form>
   </div>
  </div>
 </div>
