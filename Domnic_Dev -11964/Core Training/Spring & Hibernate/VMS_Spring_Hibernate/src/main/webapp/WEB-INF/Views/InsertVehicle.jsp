...
<body>
	...
	<form action="PerformInsert" method="post">
		...
		<div class="mb-3">
			<input placeholder="Vehicle Number" type="text" class="form-control"
				name="vNumber" id="VNumber">
		</div>
		<div class="mb-3">
			<input placeholder="Owner Name" type="text" class="form-control"
				name="oName" id="OName">
		</div>

		<div class="insert">
			<button type="submit" class="btn btn-primary" value="Insert Vehicle"
				onclick="validate()">Insert</button>
		</div>
	</form>
