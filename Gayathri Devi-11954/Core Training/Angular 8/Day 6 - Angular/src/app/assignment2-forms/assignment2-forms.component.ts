...
@Component({
  selector: 'app-assignment2-forms',
  templateUrl: './assignment2-forms.component.html',
  styleUrls: ['./assignment2-forms.component.css']
})
export class Assignment2FormsComponent {
  myForm:FormGroup;
  hide:boolean;
  constructor(){
