		...
		<table align="center" class="table">
			<tbody>
				...
				<tr>
					...
					<td><input type="text" name="vManufacturer"></td>
				</tr>
				<tr>
					<td colspan="2" align="center"><input type="submit"
						value="Update Vehicle"  class="btn btn-primary"></td>
				</tr>
			</tbody>
		</table>
	</form>-->
...
<br>
<br>    	<form action="PerformUpdate" method="post">
		<div class="mb-3">
		...
		<div class="insert">
			<button type="submit" class="btn btn-primary" value="Update Vehicle" onclick="validate()"
				 >Update</button>
		</div>
	</form>
