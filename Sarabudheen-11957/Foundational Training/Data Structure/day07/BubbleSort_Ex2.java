/*****Bubble Sort Algorithm Using LinkedList ...*****/
	...
	public static void main(String[] args) {
		...
		for (int i=0;i<size;i++) {
			for (int j=i;j<size;j++) {
				if(Initial_list.get(i) > Initial_list.get(j) ) {
					int temp = Initial_list.get(j);
					Initial_list.set(j,Initial_list.get(i));
					Initial_list.set(i,temp);
