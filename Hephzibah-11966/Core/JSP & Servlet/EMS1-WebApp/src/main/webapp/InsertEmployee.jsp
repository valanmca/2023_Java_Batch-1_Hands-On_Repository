    ...
    <form action="EMSController" method="post">
        <table width="30%" align="center" class="table table-striped w-80">
            <tr>
                ...
                <td><input type="text" placeholder="Employee Id" name="id"
                    id="empid" /></td>
            </tr>
            <tr>
                <td><b>Employee Name</b></td>
                <td><input type="text" placeholder="Employee Name" name="name"
                    id="empname" /></td>
            </tr>
            <tr>
                <td><b>Employee Salary</b></td>
                <td><input type="text" placeholder="Employee Salary"
