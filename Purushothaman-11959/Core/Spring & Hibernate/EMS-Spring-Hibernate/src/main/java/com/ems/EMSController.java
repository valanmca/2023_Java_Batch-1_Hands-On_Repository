...
public class EMSController {
	...
	public ModelAndView perfromInsert(@ModelAttribute("bean") Employee bean) {
	...
	public ModelAndView perfromUpdate(@ModelAttribute("bean") Employee bean) {
	...
	public ModelAndView perfromDelete(@ModelAttribute("bean") Employee bean) {
	...
	public ModelAndView perfromFind(@ModelAttribute("bean") Employee bean) {
